    ...
    */
    ...
    public R save(@RequestBody RenwuEntity renwu, HttpServletRequest request){
        ...
        Wrapper<RenwuEntity> queryWrapper = new EntityWrapper<RenwuEntity>()
            ...
            .eq("renwu_status_types", renwu.getRenwuStatusTypes())
            ;
...
//                            renwuEntity.setYonghuId(Integer.valueOf(data.get(0)));   //用户 要改的
//                            renwuEntity.setRenwuName(data.get(0));                    //任务标题 要改的
//                            renwuEntity.setRenwuTypes(Integer.valueOf(data.get(0)));   //任务类型 要改的
//                            renwuEntity.setRenwuMoney(data.get(0));                    //单价 要改的
//                            renwuEntity.setRenwuStatusTypes(Integer.valueOf(data.get(0)));   //任务状态 要改的
//                            renwuEntity.setRenwuContent("");//照片
